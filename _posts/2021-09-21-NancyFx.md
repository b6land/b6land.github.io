...
- 已經停止維護，有相同需求的話，可以用 ASP.Net Core 的 Minimal API 達成。
  - 快速上手：[ASP.NET Core 極簡風 - Minimal API-黑暗執行緒](https://blog.darkthread.net/blog/minimal-api/)。
  - 快速參考，例如設定檔的存取方式：[Minimal APIs quick reference - Microsoft Learn](https://learn.microsoft.com/en-us/aspnet/core/fundamentals/minimal-apis?view=aspnetcore-8.0)
